...
//
//==============================================================================
class  AFX_EXT_CLASS CConfigData  
{
public:
	CConfigData();
	...
	long   GetLong	();
	long   GetLong	(char* szSection, char* szKey, char* szDefault);
	double GetDouble();
	double GetDouble(char* szSection, char* szKey, char* szDefault);
	void   GetString(char* pData);
	void   GetString(char* szSection, char* szKey, char* szDefault, char* pData);
