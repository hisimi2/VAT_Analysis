...
// Used to reload the bitmap on system colour changes.
...
BOOL CBitmapPicture::OnEraseBkgnd(CDC* pDC) 
{
    ...
    pDC->StretchBlt(TargetRect.left+1, TargetRect.top+1, TargetRect.Width()-1, TargetRect.Height()-1, 
                    &dcMem, 
...
//BOOL CBitmapPicture::PreTranslateMessage(MSG* pMsg)
//{
