...
// SLT.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSLTApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSLTApp::OnAppAbout)
...
CSLTApp::CSLTApp()
{
	...
	SetAppID(_T("SLT.AppID.NoVersion"));
...
BOOL CSLTApp::InitInstance()
{
	...
	// 적절한 내용으로 수정해야 합니다.
	SetRegistryKey(_T("TeWing SLT Handler"));
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSLTDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CSLTView));
	if (!pDocTemplate)
		return FALSE;
...
int CSLTApp::Run()
{
	...
	info.pszErrorReportSaveDir = _T("d://Techwing//DebugReport");	//imsi
