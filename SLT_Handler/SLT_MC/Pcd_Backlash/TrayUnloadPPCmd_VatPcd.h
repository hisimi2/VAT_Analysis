...
class CTrayUnloadPPCmd_VatPcd_Param
{
public:
	CTrayUnloadPPCmd_VatPcd_Param();
	CTrayUnloadPPCmd_VatPcd_Param(
		CPoint              _Pocket,
		std::vector<CPoint> _vPicker
	);
	CTrayUnloadPPCmd_VatPcd_Param(const CTrayUnloadPPCmd_VatPcd_Param& src);
	CTrayUnloadPPCmd_VatPcd_Param& operator = (const CTrayUnloadPPCmd_VatPcd_Param& src);
	~CTrayUnloadPPCmd_VatPcd_Param();
...
class CTrayUnloadPPCmd_VatPcd :public CBaseSeqCmd
{
public:
	CTrayUnloadPPCmd_VatPcd(void);
	CTrayUnloadPPCmd_VatPcd(CTrayUnloadPPCmd_VatPcd_Param _Prm);
	~CTrayUnloadPPCmd_VatPcd(void);
	...
	// Command Parameters
	CTrayUnloadPPCmd_VatPcd_Param m_Cmd;
