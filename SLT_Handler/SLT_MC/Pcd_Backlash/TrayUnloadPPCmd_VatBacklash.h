...
class CTrayUnloadPPCmd_VatBacklash_Param
{
public:
	CTrayUnloadPPCmd_VatBacklash_Param();
	CTrayUnloadPPCmd_VatBacklash_Param(
		CPoint              _Pocket,
		std::vector<CPoint> _vPicker
	);
	CTrayUnloadPPCmd_VatBacklash_Param(const CTrayUnloadPPCmd_VatBacklash_Param& src);
	CTrayUnloadPPCmd_VatBacklash_Param& operator = (const CTrayUnloadPPCmd_VatBacklash_Param& src);
	~CTrayUnloadPPCmd_VatBacklash_Param();
...
class CTrayUnloadPPCmd_VatBacklash :public CBaseSeqCmd
{
public:
	CTrayUnloadPPCmd_VatBacklash(void);
	CTrayUnloadPPCmd_VatBacklash(CDlgPcdBacklash *pParent);
	CTrayUnloadPPCmd_VatBacklash(CTrayUnloadPPCmd_VatBacklash_Param _Prm);
	~CTrayUnloadPPCmd_VatBacklash(void);
	...
	CTrayUnloadPPCmd_VatBacklash_Param m_Cmd;
