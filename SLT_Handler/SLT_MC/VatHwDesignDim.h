...
public:
	...
	{
	public:
		CPointF m_PcdOffset_X;
		CPointF m_PcdStartXPos_XZ;
		CPointF m_PcdStartYPos_XZ;
		void Save();
		void Load();
...
public:
	...
	public:
		...
		CPointF m_BacklashTargetPos_XZ;
		CPointF m_BacklashStartPos_X;
		CPointF m_BacklashEndPos_X;
...
public:
	...
	public:
		CPointF m_BacklashOffset_X[eSpeed_MAX];
		CPointF m_BacklashOffset_Y[eDistance_MAX][eSpeed_MAX];
		CPointF m_BacklashTargetPos_XYZ;
		CPointF m_BacklashStartPos_XY;
		CPointF m_BacklashEndPos_XY;
...
public:
	...
	{
	public:
		CPointF m_AccuracyStartPos_XYZ;
		void Save();
		void Load();
...
public:
	...
	{
	public:
		CPointF m_RepeatabilityStartPos_XZ;
		void Save();
		void Load();
...
public:
	...
	{
	public:
		CPointF m_RepeatabilityStartPos_XYZ;
		void Save();
		void Load();
...
extern CVatRepeatability g_VatRepeatability;
extern CVatAccuracy g_VatAccuracy;
