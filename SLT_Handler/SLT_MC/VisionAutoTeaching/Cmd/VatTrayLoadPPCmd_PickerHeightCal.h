#pragma once
class CVatTrayLoadPPCmd_PickerHeightCal : public CBaseSeqCmd
{
public:
	CVatTrayLoadPPCmd_PickerHeightCal();
	~CVatTrayLoadPPCmd_PickerHeightCal();
...
// 	
// 		height_cal_move_x_px_py_target_pos,
// 		height_cal_move_x_px_py_target_pos_chk,
		...
		height_cal_save_slow_height_pos_vision_auto_teaching,
...
public:
	...
	std::vector<CPoint> m_vCmdPicker; //8ea or StdPicker
