================================================================================
    MFC 라이브러리 : SLT_MC 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 SLT_MC 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 SLT_MC 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
SLT_MC.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CSLT_MCApp 응용 프로그램
    클래스를 선언합니다.

SLT_MC.cpp
    응용 프로그램 클래스 CSLT_MCApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
SLT_MCDoc.h, SLT_MCDoc.cpp - 문서
    이 파일에는 CSLT_MCDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CSLT_MCDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

SLT_MCView.h, SLT_MCView.cpp - 문서 뷰
    이 파일에는 CSLT_MCView 클래스가 들어 있습니다.
    CSLT_MCView 개체는 CSLT_MCDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 SLT_MC.pch와
