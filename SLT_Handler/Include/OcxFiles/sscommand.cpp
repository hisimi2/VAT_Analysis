...
BOOL CSSCommand::GetActiveColors()
{
	BOOL result;
...
void CSSCommand::SetActiveColors(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
short CSSCommand::GetPictureAnimationCount()
{
	short result;
...
void CSSCommand::SetPictureAnimationCount(short nNewValue)
{
	static BYTE parms[] =
		VTS_I2;
...
short CSSCommand::GetPictureFrame()
{
	short result;
...
void CSSCommand::SetPictureFrame(short nNewValue)
{
	static BYTE parms[] =
		VTS_I2;
...
long CSSCommand::GetPictureMaskColorSource()
{
	long result;
...
void CSSCommand::SetPictureMaskColorSource(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CSSCommand::SetRefTagVariant(VARIANT* newValue)
{
	static BYTE parms[] =
		VTS_PVARIANT;
...
void CSSCommand::PlaySoundFile(LPCTSTR Sound, const VARIANT& SoundFlags)
{
	static BYTE parms[] =
...
CPicture CSSCommand::GetShape()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x49, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CPicture(pDispatch);
}

void CSSCommand::SetShape(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
...
void CSSCommand::SetRefShape(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
	InvokeHelper(0x49, DISPATCH_PROPERTYPUTREF, VT_EMPTY, NULL, parms,
		 newValue);
}

long CSSCommand::GetShapeSize()
{
	long result;
...
void CSSCommand::SetShapeSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
