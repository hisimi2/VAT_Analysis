...
BOOL CDSSPanel::GetActiveColors()
{
	BOOL result;
...
void CDSSPanel::SetActiveColors(BOOL propVal)
{
...
short CDSSPanel::GetPictureAnimationCount()
{
	short result;
...
void CDSSPanel::SetPictureAnimationCount(short propVal)
{
	SetProperty(0x44, VT_I2, propVal);
}

short CDSSPanel::GetPictureFrame()
{
	short result;
...
void CDSSPanel::SetPictureFrame(short propVal)
{
...
long CDSSPanel::GetPictureMaskColorSource()
{
	long result;
...
void CDSSPanel::SetPictureMaskColorSource(long propVal)
{
...
BOOL CDSSPanel::GetPictureBackgroundUseMask()
{
	BOOL result;
...
void CDSSPanel::SetPictureBackgroundUseMask(BOOL propVal)
{
...
void CDSSPanel::On()
{
	if(GetPictureFrame()==2) return;

	SetPictureFrame(2);
	//SetBackColor(RGB(100,100,100));
}

// VAT Status [9/8/2025 dohyeong.kim]
//<Frame>
// 0 : Init (ÃÊ·Ï)
// 1 : Idle (³ë¶û)
// 2 : Disconeect, Error (»¡°­)
// 3 : Success (¿¬µÎ)
void CDSSPanel::SetStatus(int nFrame)
{	
// 	int nFrame = 0;
// 
// 	switch (nStatus)
// 	{
// 	case VAT_RCV_STATUS_INIT:			nFrame = 0; break;
// 	case VAT_RCV_STATUS_IDLE:			nFrame = 1; break;
// 	case VAT_RCV_STATUS_DISCONNECT:		nFrame = 2; break;
// 	case VAT_RCV_STATUS_SUCCESS:		nFrame = 3; break;
// 	case VAT_RCV_STATUS_ERROR:			nFrame = 2; break;
// 	}

	if (GetPictureFrame() == nFrame) return;

	SetPictureFrame(nFrame);
}