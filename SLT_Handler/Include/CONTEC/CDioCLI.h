...
//============================================================-
// CDioCLI.H
// C++/CLI Header file for CONTEC Digital I/O device
//                                          CONTEC.Co.,Ltd.
//============================================================-
...
namespace	CDioCLI
{
	public delegate void PINTCALLBACK(short Id, long wParam, long lParam, void *Param);
	public delegate void PTRGCALLBACK(short Id, long wParam, long lParam, void *Param);
	public delegate void PDMCOUNTCALLBACK(short Id, long wParam, long lParam, void *Param);
	public delegate void PDMSTOPCALLBACK(short Id, long wParam, long lParam, void *Param);
	
	//-------------------------------------------------
	// Prototype definition
	//-------------------------------------------------
	// Common function
	[DllImport("cdio.dll")] long DioInit(String^ DeviceName, short *Id);
	[DllImport("cdio.dll")] long DioExit(short Id);
	[DllImport("cdio.dll")] long DioResetDevice(short Id);
	[DllImport("cdio.dll")] long DioGetErrorString(long ErrorCode, StringBuilder^ ErrorString);	
	// Digital filter function
	[DllImport("cdio.dll")] long DioSetDigitalFilter(short Id, short FilterValue);
	[DllImport("cdio.dll")] long DioGetDigitalFilter(short Id, short *FilterValue);	
	// I/O Direction function
	[DllImport("cdio.dll")] long DioSetIoDirection(short Id, long Dir);
	[DllImport("cdio.dll")] long DioGetIoDirection(short Id, long *Dir);
	[DllImport("cdio.dll")] long DioSetIoDirectionEx(short Id, long dwDir);
	[DllImport("cdio.dll")] long DioGetIoDirectionEx(short Id, long *dwDir);
	[DllImport("cdio.dll")] long DioSet8255Mode(short Id, short ChipNo, short CtrlWord);
	[DllImport("cdio.dll")] long DioGet8255Mode(short Id, short ChipNo, short *CtrlWord);
	// Simple I/O function
	[DllImport("cdio.dll")] long DioInpByte(short Id, short PortNo, Byte *Data);
	[DllImport("cdio.dll")] long DioInpBit(short Id, short BitNo, Byte *Data);
	[DllImport("cdio.dll")] long DioOutByte(short Id, short PortNo, Byte Data);
	[DllImport("cdio.dll")] long DioOutBit(short Id, short BitNo, Byte Data);
	[DllImport("cdio.dll")] long DioEchoBackByte(short Id, short PortNo, Byte *Data);
	[DllImport("cdio.dll")] long DioEchoBackBit(short Id, short BitNo, Byte *Data);	
	// Multiple I/O function
	[DllImport("cdio.dll")] long DioInpMultiByte(short Id, short *PortNo, short PortNum, Byte *Data);
	[DllImport("cdio.dll")] long DioInpMultiBit(short Id, short *BitNo, short BitNum, Byte *Data);
	[DllImport("cdio.dll")] long DioOutMultiByte(short Id, short *PortNo, short PortNum, Byte *Data);
	[DllImport("cdio.dll")] long DioOutMultiBit(short Id, short *BitNo, short BitNum, Byte *Data);
	[DllImport("cdio.dll")] long DioEchoBackMultiByte(short Id, short *PortNo, short PortNum, Byte *Data);
	[DllImport("cdio.dll")] long DioEchoBackMultiBit(short Id, short *BitNo, short BitNum, Byte *Data);	
	// Interrupt function
	[DllImport("cdio.dll")] long DioNotifyInterrupt(short Id, short BitNo, short Logic, int hWnd);
	[DllImport("cdio.dll")] long DioSetInterruptCallBackProc(short Id, IntPtr CallBackProc, void *Param);	
	// Trigger function
	[DllImport("cdio.dll")] long DioNotifyTrg(short Id, short TrgBit, short TrgKind, long Tim, int hWnd);
	[DllImport("cdio.dll")] long DioStopNotifyTrg(short Id, short TrgBit);
	[DllImport("cdio.dll")] long DioSetTrgCallBackProc(short Id, IntPtr CallBackProc, void *Param);	
	// Information function
	[DllImport("cdio.dll")] long DioGetDeviceInfo(String^ Device, short InfoType, void *Param1, void *Param2, void *Param3);
	[DllImport("cdio.dll")] long DioQueryDeviceName(short Index, StringBuilder^ DeviceName, StringBuilder^ Device);
	[DllImport("cdio.dll")] long DioGetMaxPorts(short Id, short *InPortNum, short *OutPortNum);
	// DM function
	[DllImport("cdio.dll")] long DioDmSetDirection(short Id, short Direction);
	[DllImport("cdio.dll")] long DioDmGetDirection(short Id, short *Direction);
	[DllImport("cdio.dll")] long DioDmSetStandAlone(short Id);
	[DllImport("cdio.dll")] long DioDmSetMaster(short Id, short ExtSig1, short ExtSig2, short ExtSig3, short MasterHalt, short SlaveHalt);
	[DllImport("cdio.dll")] long DioDmSetSlave(short Id, short ExtSig1, short ExtSig2, short ExtSig3, short MasterHalt, short SlaveHalt);
	[DllImport("cdio.dll")] long DioDmSetStartTrigger(short Id, short Direction, short Start);
	[DllImport("cdio.dll")] long DioDmSetStartPattern(short Id, unsigned long Pattern, unsigned long Mask);
	[DllImport("cdio.dll")] long DioDmSetClockTrigger(short Id, short Direction, short Clock);
	[DllImport("cdio.dll")] long DioDmSetInternalClock(short Id, short Direction, unsigned long Clock, short Unit);
	[DllImport("cdio.dll")] long DioDmSetStopTrigger(short Id, short Direction, short Stop);
	[DllImport("cdio.dll")] long DioDmSetStopNumber(short Id, short Direction, unsigned long StopNumber);
	[DllImport("cdio.dll")] long DioDmFifoReset(short Id, short Reset);
	[DllImport("cdio.dll")] long DioDmSetBuffer(short Id, short Direction, IntPtr Buffer, unsigned long Length, short IsRing);
	[DllImport("cdio.dll")] long DioDmSetTransferStartWait(short Id, short Time);
	[DllImport("cdio.dll")] long DioDmTransferStart(short Id, short Direction);
	[DllImport("cdio.dll")] long DioDmTransferStop(short Id, short Direction);
	[DllImport("cdio.dll")] long DioDmGetStatus(short Id, short Direction, unsigned long *Status, unsigned long *Err);
	[DllImport("cdio.dll")] long DioDmGetCount(short Id, short Direction, unsigned long *Count, unsigned long *Carry);
	[DllImport("cdio.dll")] long DioDmGetWritePointer(short Id, short Direction, unsigned long *WritePointer, unsigned long *Count, unsigned long *Carry);
	[DllImport("cdio.dll")] long DioDmSetStopEvent(short Id, short Direction, int hWnd);
	[DllImport("cdio.dll")] long DioDmSetStopCallBackProc (short Id, IntPtr CallBackProc, void *Param);
	[DllImport("cdio.dll")] long DioDmSetCountEvent(short Id, short Direction, unsigned long Count, int hWnd);
	[DllImport("cdio.dll")] long DioDmSetCountCallBackProc(short Id, IntPtr CallBackProc, void *Param);
	// Demo Device I/O function
	[DllImport("cdio.dll")] long DioSetDemoByte(short Id, short PortNo, Byte Data);
	[DllImport("cdio.dll")] long DioSetDemoBit(short Id, short BitNo, Byte Data);
